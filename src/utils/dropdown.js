export function initDropdown() {
  ...
  const dropdownShipmentContent = document.querySelector(
    ".dropdown-shipment-content"
  );
  const dropdownPaymentContent = document.querySelector(
    ".dropdown-payment-content"
  );
